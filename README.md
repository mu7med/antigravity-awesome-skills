<!-- registry-sync: version=11.0.0; skills=1452; stars=36771; updated_at=2026-05-08T07:33:35+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,452+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,452+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,452+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,452+ Skills](#browse-1452-skills)
...
If you want a faster answer than "browse all 1,452+ skills", start with a tool-specific guide:
